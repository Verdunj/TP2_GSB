...
--
-- Host: localhost    Database: gsb_frais2
-- ------------------------------------------------------
...
INSERT INTO `FicheFrais` VALUES ('a17','10',0,0.00,'2017-10-12','CR');
...
INSERT INTO `LigneFraisForfait` VALUES ('a17','10','ETP',0),('a17','10','KM',0),('a17','10','NUI',0),('a17','10','REP',0);
...
CREATE TABLE `Praticien` (
  ...
  KEY `Specialite` (`refSpecialite`),
  CONSTRAINT `Specialite` FOREIGN KEY (`refSpecialite`) REFERENCES `Specialite` (`idSpecialite`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Praticien` VALUES (0,'bobo','oeil');
...
INSERT INTO `Specialite` VALUES ('oeil','Ophtalmologiste'),('pied','Podologue');
...
CREATE TABLE `Visite` (
  ...
  KEY `Patricien` (`refPraticien`),
  KEY `Visiteur` (`refVisiteur`),
  CONSTRAINT `Patricien` FOREIGN KEY (`refPraticien`) REFERENCES `Praticien` (`idPraticien`),
  CONSTRAINT `Visiteur` FOREIGN KEY (`refVisiteur`) REFERENCES `Visiteur` (`id`)
...
INSERT INTO `Visite` VALUES (31,'a17',0,'2017-10-12 09:13:16',3);
...
-- Dump completed on 2017-10-12 11:14:10
